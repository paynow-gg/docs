...
export const description =
  'Learn everything there is to know about the PayNow API and integrate Protocol into your product.'
...
Use the PayNow API to access contacts, conversations, group messages, and more and seamlessly integrate your product into the workflows of dozens of devoted Protocol users. {{ className: 'lead' }}
