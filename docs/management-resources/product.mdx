...
<Row>
  <Col>
    ...
    To access product information using a [customer token](management-resources/customer#create-customer-token),
    use the [Storefront Product API](store-resources/product).
  </Col>
  <Col sticky>
    <Endpoints>
...
<Row>
  <Col>
    <Fields>
      ...
      <Field name="user_stock_limit" type="stock limit" typeHref="#stock-limit-structure">
    ...
    Stock Limits can apply at the [store](management-resources/store) and [customer](management-resources/customer) level.
    ...
    Contains a partial set fields that refer to a [tag](management-resources/tag)
    ...
    Contains a partial set fields that refer to a [game server](management-resources/gameserver)
    ...
    <Fields>
      <Field name="stage" type="enum">
        ...
        <Enums vertical>
          <Enum value="on_purchase">runs when the product gets added to the customer's inventory</Enum>
          <Enum value="on_expire">runs when the product is removed from the customer's inventory</Enum>
  ...
  <Col>
    ...
    <Fields parameters>
      ...
      <Field name="description" type="string" required>
        the description of the product (1 - 10,000 characters)
      ...
      <Field name="store_stock_limit.enabled" type="boolean" optional default={false}>
        whether the stock should be limited across the entire [store](management-resources/store)
      </Field>
      ...
      <Field name="customer_stock_limit.enabled" type="boolean" optional default={false}>
        whether the stock should be limited for each individual customer [customer](management-resources/customer)
      </Field>
      ...
      <Field name="tags" type="[]flake" optional>
        an array of IDs specifying which [tags](management-resources/tag) to apply to this product
      </Field>
      <Field name="gameservers" type="[]flake" optional>
        an array of IDs specifying which [game servers](management-resources/gameserver) this product's commands should run on
      </Field>
