...
<Row>
    ...
    <Col sticky>
        ...
        ```json {{ title: 'Create Game Server Response' }}
        {
            "id": "124249183568797696",
            "store_id": "12345",
            "name": "NewGameServer",
...
<Row>
    <Col>
        <Fields query parameters>
            <Field name="gameServerID" type="flake">
                id of the game server whose token is to be reset
            </Field>
        </Fields>
...
This endpoint deletes a specified game server based on the provided gameServerID.

<Row>
    <Col>
        <Fields query parameters>
            <Field name="gameServerID" type="flake">
                id of the game server to be deleted
            </Field>
        </Fields>

        ### Returns
        Does not return a response object. Responds with HTTP status code 204 No Content on successful deletion.
